...
(function ($) {
    $(document).ready(function () {
        ...
        videoPlayerIntervalEventsConductorIntegrationTests.asyncTest("Integration test: intervalEventsConductor with html5MediaTimer. (This test is expected to fail with non-html5 browsers)", function () {
